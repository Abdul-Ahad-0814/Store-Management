...
namespace {
struct qt_meta_tag_ZN6updateE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN6updateE = QtMocHelpers::stringData(
    "update",
...
Q_CONSTINIT static const uint qt_meta_data_ZN6updateE[] = {
...
Q_CONSTINIT const QMetaObject update::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6updateE.offsetsAndSizes,
    qt_meta_data_ZN6updateE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6updateE_t,
        // Q_OBJECT / Q_GADGET
...
void *update::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6updateE.stringdata0))
